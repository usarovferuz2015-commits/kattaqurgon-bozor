...
import { FiShoppingCart, FiHeart, FiSearch, FiMessageSquare } from 'react-icons/fi';
          ...
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                title="Murojaat"
              >
                <FiMessageSquare className="w-5 h-5 text-dark-600" />
              </button>

              <Link to="/search" className="p-2 hover:bg-gray-100 rounded-xl transition-colors">
                <FiSearch className="w-5 h-5 text-dark-600" />
              </Link>

              <Link to="/favorites" className="p-2 hover:bg-gray-100 rounded-xl transition-colors">
